 ...
 */
@Service
public class UserWechatServiceImpl extends BaseServiceImpl<UserWechatMapper, UserWechat, UserWechatRepository, UserWechatView> implements UserWechatService {
