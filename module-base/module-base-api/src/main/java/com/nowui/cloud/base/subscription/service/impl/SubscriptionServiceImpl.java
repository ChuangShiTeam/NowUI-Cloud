 ...
 */
@Service
public class SubscriptionServiceImpl extends SuperServiceImpl<SubscriptionMapper, Subscription,SubscriptionRepository,SubscriptionView> implements SubscriptionService {
