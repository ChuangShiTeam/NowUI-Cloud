package com.nowui.cloud.base.notifyinfo.controller.admin;
 ...
 * 2018-01-28
 */
@Api(value = "消息表", description = "消息表管理端接口管理")
@RestController
