 ...
 */
@Component
@Document(indexName = "nowui", type = "member_perference_language_info")
@TableName(value = "member_perference_language_info")
public class MemberPerferenceLanguage extends BaseEntity {
