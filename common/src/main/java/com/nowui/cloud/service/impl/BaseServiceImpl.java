 ...
 * 2018-01-29
 */
public class BaseServiceImpl<M extends BaseMapper<E>, E extends BaseEntity, R extends BaseRepository<V>, V extends BaseView> extends ServiceImpl<M, E> implements BaseService<E, V> {
