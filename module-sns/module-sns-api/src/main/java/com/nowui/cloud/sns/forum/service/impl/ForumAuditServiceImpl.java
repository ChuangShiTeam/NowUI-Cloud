...
public class ForumAuditServiceImpl extends BaseServiceImpl<ForumAuditMapper, ForumAudit> implements ForumAuditService {
    ...
    @Override
    public Integer adminCount(String appId, Integer forumAuditStatus, String forumId) {
        Integer count = count(
    ...
    @Override
    public List<ForumAudit> adminList(String appId, Integer forumAuditStatus, String forumId, Integer pageIndex, Integer pageSize) {
