...
public interface ForumAuditService extends BaseService<ForumAudit> {
     ...
     */
    Integer adminCount(String appId, Integer forumAuditStatus, String forumId);
     ...
     */
    List<ForumAudit> adminList(String appId, Integer forumAuditStatus, String forumId, Integer pageIndex, Integer pageSize);
}
