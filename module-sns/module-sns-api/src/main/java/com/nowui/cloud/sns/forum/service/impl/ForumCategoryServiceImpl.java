...
public class ForumCategoryServiceImpl extends BaseServiceImpl<ForumCategoryMapper, ForumCategory> implements ForumCategoryService {
    ...
    @Override
    public Integer adminCount(String appId, String forumCategoryName, String forumCategoryThumb, Integer forumCategorySort, Boolean forumCategoryEnabled, Boolean forumCategoryRecommand) {
        Integer count = count(
    ...
    @Override
    public List<ForumCategory> adminList(String appId, String forumCategoryName, String forumCategoryThumb, Integer forumCategorySort, Boolean forumCategoryEnabled, Boolean forumCategoryRecommand, Integer pageIndex, Integer pageSize) {
