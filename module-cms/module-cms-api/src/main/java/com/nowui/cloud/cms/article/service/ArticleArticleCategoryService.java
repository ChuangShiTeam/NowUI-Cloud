...
public interface ArticleArticleCategoryService extends SuperService<ArticleArticleCategory, ArticleArticleCategoryView> {
     ...
     */
    ArticleArticleCategoryView findPrimaryByArticleId(String articleId);
     ...
     */
    List<ArticleArticleCategoryView> listByArticleId(String articleId);
     ...
     * @return List<ArticleArticleCategory> 文章文章分类列表
     */
    List<ArticleArticleCategoryView> listNotPrimaryByArticleId(String articleId);
     ...
     * @return List<ArticleArticleCategory> 文章文章分类列表
     */
    List<ArticleArticleCategoryView> listPrimaryByArticleCategoryId(String articleCategoryId);
