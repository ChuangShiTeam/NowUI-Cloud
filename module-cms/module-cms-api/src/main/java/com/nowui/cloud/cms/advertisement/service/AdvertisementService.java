 ...
 * 2017年12月26日
 */
public interface AdvertisementService extends BaseService<Advertisement, AdvertisementView> {
     ...
     * @param m 从m条开始
     * @param n 取n条数据
     * @return List<AdvertisementView> 广告视图列表
     */
     ...
     * @return List<AdvertisementView> 广告视图列表
     */
    List<AdvertisementView> listByCategoryCode(String appId, String advertisementCategoryCode);
